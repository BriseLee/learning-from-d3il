...
from .objects.pushcube_objects import get_obj_list, init_end_eff_pos
...
class Push_Cube_Env(GymEnvWrapper):
    def __init__(
        self,
        n_substeps: int = 35,
        ...
        self.log_dict = {
            "pushed_box": ObjectLogger(scene, self.pushed_box),
...
#to do quat?
    ...
    def check_mode(self):
        ...
        robot_pos = self.robot.current_c_pos
    ...
    def get_reward(self, if_sparse=False):
        eef_pos = self.robot.current_c_pos[:2]
        ...
        robot_box_dist_reward = np.linalg
