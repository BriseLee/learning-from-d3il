...
if __name__ == "__main__":
    ...
    replay_instance = BlockPickReplay(scene, robot, recorded_data_path="environments/dataset/data/pushcube/push_data/feedback_withoutforce/state/PushCube_043.pkl")
