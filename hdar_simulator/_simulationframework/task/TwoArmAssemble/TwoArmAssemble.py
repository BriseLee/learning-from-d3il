...
class TwoArmAssemble(SFSimulator):
    ...
    def __init__(self, host_address=None):
        ...
        super().__init__('TwoArmAssemble',host_address)
    ...
    def reset(self):
        ...
        if picked_box_pos[0] > 0.45:  
            picked_box_pos[0]-0.05    
        picked_box_pos = (picked_box_pos[0],picked_box_pos[1],0.1)
...
class TwoArmAssembleVibration(TwoArmAssemble):
    ...
    def after_step(self):
        ...
        self.mj_scene,
        target_pairs={
                ('picked_cylinder', 'target_box0'),
                ('picked_cylinder','target_box1'),
                ('picked_cylinder', 'target_box2'),
                ('picked_cylinder', 'target_box3'),
        },
        )
